...
namespace TheLegendOfHilda.Scenes
{
    public class EntranceRoom : IScene
    {
        ...
        public void Init()
        {
            ...
            _room.Add(new TileWalker(0, 1, 1, 12).Get(x => new Wall(Rotation.Left, x)));
            _room.Add(new TileWalker(14, 1, 2, 12).Get(x => new Wall(Rotation.Right, x)));
            _room.Add(new TileWalker(1, 12, 14, 1).Get(x => new Wall(Rotation.Down, x)));
            ...
            _room.Add(new TileWalker(2, 1, 2, 10).Get(x => new Tile("walledge", x, Rotation.Left, false)));
            _room.Add(new TileWalker(12, 1, 3, 10).Get(x => new Tile("walledge", x, Rotation.Right, false)));
            _room.Add(new TileWalker(2, 10, 12, 1).Get(x => new Tile("walledge", x, Rotation.Down, false)));

            _room.Add(new TileWalker(2, 1, 2, 1).Get(x => new Tile("walledgecorner", x, Rotation.Up, false)));
            _room.Add(new TileWalker(2, 1, 12, 1).Get(x => new Tile("walledgecorner", x, Rotation.Left, false)));
            _room.Add(new TileWalker(12, 1, 2, 1).Get(x => new Tile("walledgecorner", x, Rotation.Right, false)));
            _room.Add(new TileWalker(12, 1, 12, 1).Get(x => new Tile("walledgecorner", x, Rotation.Down, false)));
