...
namespace TheLegendOfHilda.Scenes
{
    public class MainHallRoom : IScene
    {
        ...
        public void Init()
        {
            ...
            _room.Add(new Door(DoorState.Locked, new TileLocation(7, 0), Rotation.Up));
            _room.Add(new Door(DoorState.Open, new TileLocation(7, 18), Rotation.Down));
            _room.Add(new Door(DoorState.Open, new TileLocation(0, 8), Rotation.Left));
            _room.Add(new Door(DoorState.Open, new TileLocation(14, 8), Rotation.Right));
        }
